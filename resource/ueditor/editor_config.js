...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:UEDITOR_IMG_URL             //图片上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:UEDITOR_IMG_MANAGER_URL       //图片在线管理的处理地址
        ...
        //word转存配置区
        ,wordImageUrl:UEDITOR_IMG_URL             //word转存提交地址
        ,wordImagePath:'/'                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数


        //获取视频数据的地址
        ,getMovieUrl:UEDITOR_GET_MOVIE                  //视频数据获取地址
