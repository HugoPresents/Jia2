...
-- Dumping structure for table jia2.album
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='相册';

-- Dumping data for table jia2.album: ~3 rows (approximately)
/*!40000 ALTER TABLE `album` DISABLE KEYS */;
INSERT IGNORE INTO `album` (`id`, `owner_id`, `type_id`, `name`, `comment`, `status`, `tags`, `cover_id`, `add_time`) VALUES
	(1, 13, 1, '默认相册', '', 2, '兔子 相册', NULL, 1339582149),
	(2, 13, 1, '加加社团的相册', '相册描述', 2, '标签', NULL, 1339657290),
	(3, 8, 2, '加加社团的相册', '扔个人体', 2, '标签', NULL, 1339658771);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='日志';

-- Dumping data for table jia2.blog: ~5 rows (approximately)
...
INSERT IGNORE INTO `blog` (`id`, `owner_id`, `type_id`, `title`, `content`, `tags`, `add_time`, `update_time`, `status`, `draft`, `views`, `comments`, `order`) VALUES
	...
	(5, 11, 1, 'Fedora 16 中文字体优化！', '<p  arial, helvetica, sans-serif;background-color:#f7f7f7;margin-top:0px;margin-bottom:22px;">好吧～来源是这儿<br  /><a href="http://www.netroby.com/html/2011/linux-unix_1208/238.html" class="external" rel="nofollow" target="_blank"   arial, helvetica, sans-serif;background-color:#f7f7f7;margin-top:0px;margin-bottom:22px;">按照此法设置重启之后Fedora 16之后，效果相当之棒！一举搞定fedora中文渲染不完美的短板！哈哈</p><p  arial, helvetica, sans-serif;background-color:#f7f7f7;margin-top:0px;margin-bottom:22px;">哥有两张效果图，VirtualBox上先实验的</p><p  arial, helvetica, sans-serif;background-color:#f7f7f7;margin-top:0px;margin-bottom:22px;">这两张是用的方正准圆字体，<span   <img src="http://rabbit52.com/wp-includes/images/smilies/icon_smile.gif" alt=":)" class="wp-smiley"  /> </span> )如果你觉得有点粗，可以用文泉驿字体或者用UBUNTU渲染模式！（点击查看大图）</p><a href="http://www.flickr.com/photos/tuzki-zhang/6599723647/" title="2011123019:27:0101" rel="flickr-mgr nofollow" class="flickr-image external" target="_blank"  arial, helvetica, sans-serif;background-color:#f7f7f7;"><img src="http://farm8.static.flickr.com/7013/6599723647_980a1a2fdd.jpg" alt="2011123019:27:0101" class="flickr-small" longdesc="http://rabbit52.com/2011/linux/infinality-fedora-16"  0px;padding:4px;border:1px solid #dddddd;vertical-align:baseline;max-width:610px;height:auto;background-color:#ffffff;" /></a><span  arial, helvetica, sans-serif;font-size:13px;background-color:#f7f7f7"></span><p  arial, helvetica, sans-serif;background-color:#f7f7f7;margin-top:0px;margin-bottom:22px;"><span id="more-1196"  href="http://www.flickr.com/photos/tuzki-zhang/6599723115/" title="2011123019:23:0601" rel="flickr-mgr nofollow" class="flickr-image external" target="_blank"  arial, helvetica, sans-serif;background-color:#f7f7f7;"><img src="http://farm8.static.flickr.com/7028/6599723115_65ac95f04b.jpg" alt="2011123019:23:0601" class="flickr-small" longdesc="http://rabbit52.com/2011/linux/infinality-fedora-16"  0px;padding:4px;border:1px solid #dddddd;vertical-align:baseline;max-width:610px;height:auto;background-color:#ffffff;" /></a><span  arial, helvetica, sans-serif;font-size:13px;background-color:#f7f7f7"></span><p  arial, helvetica, sans-serif;background-color:#f7f7f7;margin-top:0px;margin-bottom:22px;"> </p><p  arial, helvetica, sans-serif;background-color:#f7f7f7;margin-top:0px;margin-bottom:22px;">PS:俺现在太激动了~走了，把Ubuntu换成Fedora！</p><p><br /></p>', '', 1344300597, 1344300597, 2, 0, 0, 0, 0);
/*!40000 ALTER TABLE `blog` ENABLE KEYS */;


-- Dumping structure for table jia2.blog_comment
...
) ENGINE=InnoDB AUTO_INCREMENT=162 DEFAULT CHARSET=utf8 COMMENT='动态评论';

-- Dumping data for table jia2.comment: ~60 rows (approximately)
...
INSERT IGNORE INTO `comment` (`id`, `post_id`, `user_id`, `content`, `time`, `status`) VALUES
	...
	(156, 64, 13, 'ceshi', '1339644226', 1),
	(157, 63, 13, 'ceegrg', '1339644239', 1),
	(158, 64, 13, '回复', '1339730976', 1),
	(159, 64, 13, '再来', '1339730980', 1),
	(160, 56, 11, '你妹啊！', '1344319959', 1),
	(161, 56, 11, '怎么会这样子', '1344320081', 1);
...
INSERT IGNORE INTO `corporation` (`id`, `name`, `school_id`, `user_id`, `avatar`, `comment`) VALUES
	...
	(10, '加加加社团', 1, 11, 'default.jpg', '家具爱家家');
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='社团权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='社团变化表';
...
-- Dumping structure for table jia2.corporation_request
...
-- Dumping structure for table jia2.entity_type
CREATE TABLE IF NOT EXISTS `entity_type` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `comment` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='实体类型（包括post，album，blog的类别）';
...
-- Dumping structure for table jia2.gossip
CREATE TABLE IF NOT EXISTS `gossip` (
  ...
  CONSTRAINT `FK_gossip_entity_type` FOREIGN KEY (`type_id`) REFERENCES `entity_type` (`id`),
  CONSTRAINT `FK_gossip_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='留言';

-- Dumping data for table jia2.gossip: ~4 rows (approximately)
/*!40000 ALTER TABLE `gossip` DISABLE KEYS */;
INSERT IGNORE INTO `gossip` (`id`, `user_id`, `type_id`, `receiver_id`, `content`, `time`) VALUES
	(1, 13, 2, 8, '留言', 1339689686),
	(2, 13, 2, 8, '再来', 1339689704),
	(3, 13, 2, 7, '我是第一个哦！win', 1339690213),
	(4, 13, 2, 8, '留言啊！亲', 1339724723);
...
-- Dumping structure for table jia2.notify
...
INSERT IGNORE INTO `notify` (`id`, `user_id`, `receiver_id`, `type_id`, `time`, `content`, `status`) VALUES
	...
	(55, 11, 15, 9, 1344320081, '评论了你的<a href="http://jia2.localhost/post/56">动态</a>', 1);
/*!40000 ALTER TABLE `notify` ENABLE KEYS */;


-- Dumping structure for table jia2.notify_meta
...
-- Dumping data for table jia2.notify_meta: ~0 rows (approximately)
/*!40000 ALTER TABLE `notify_meta` DISABLE KEYS */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='图片';

-- Dumping data for table jia2.photo: ~5 rows (approximately)
...
INSERT IGNORE INTO `photo` (`id`, `album_id`, `name`, `original`, `thumb`) VALUES
	...
	(2, 1, '图片', 'data/album/personal/76671339644039.jpg', 'data/album/personal/76671339644039_thumb.jpg'),
	(3, 3, '图片', 'data/album/personal/29941339661750.jpg', 'data/album/personal/29941339661750_thumb.jpg'),
...
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 COMMENT='帖子动态';

-- Dumping data for table jia2.post: ~17 rows (approximately)
...
INSERT IGNORE INTO `post` (`id`, `type_id`, `owner_id`, `title`, `content`, `image`, `time`, `status`) VALUES
	...
	(63, 1, 13, NULL, '测试测试', NULL, '1339583250', 1),
	(64, 1, 13, NULL, 'fabiao', NULL, '1339644222', 1);
...
-- Dumping structure for table jia2.ps_region
...
INSERT IGNORE INTO `ps_region` (`region_id`, `parent_id`, `region_name`, `region_type`) VALUES
	...
	(3407, 3401, '肥东县', 3),
	(3408, 3401, '肥西县', 3);
/*!40000 ALTER TABLE `ps_region` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  CONSTRAINT `fk_users_entity_type` FOREIGN KEY (`type_id`) REFERENCES `entity_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
