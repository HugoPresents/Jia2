...
-- Dumping data for table jia2.album: ~1 rows (approximately)
/*!40000 ALTER TABLE `album` DISABLE KEYS */;
REPLACE INTO `album` (`id`, `owner_id`, `type_id`, `name`, `comment`, `status`, `tags`, `cover_id`, `add_time`) VALUES
...
-- Dumping data for table jia2.blog: ~4 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=156 DEFAULT CHARSET=utf8 COMMENT='动态评论';

-- Dumping data for table jia2.comment: ~56 rows (approximately)
...
-- Dumping data for table jia2.gossip: ~0 rows (approximately)
/*!40000 ALTER TABLE `gossip` DISABLE KEYS */;
REPLACE INTO `gossip` (`id`, `user_id`, `type_id`, `receiver_id`, `content`, `time`) VALUES
...
-- Dumping data for table jia2.photo: ~2 rows (approximately)
/*!40000 ALTER TABLE `photo` DISABLE KEYS */;
REPLACE INTO `photo` (`id`, `album_id`, `name`, `original`, `thumb`) VALUES
...
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='帖子动态';
