...
<div class="container mainBody">
    <div class="mt20 clearfix feed_switcher ">
        ...
        <? if($j_corporations): 
        ?>
        <a title="我参加的社团" href="#join" id="" class="switch<?= $first ? '':' first'?> btn"  data-toggle="tab">我参加的社团</a>
        <? $first = TRUE;endif ?>
        <? if($f_corporations): ?>
        <a title="我关注的社团" href="#atten" id="" class="switch<?= $first ? '':' first'?> btn"  data-toggle="tab">我关注的社团</a>
        <? $first = TRUE;endif ?>
        </div>
        <div class="feed_op">
    ...
    <ul class="asso_mg tab-pane active" id="manage">
        <? if($m_corporations): ?>
        ...
        <? endforeach ?>
        <? endif ?>
    </ul><ul class="asso_mg tab-pane" id="join">
        <? if($j_corporations): ?>
        ...
        <? endforeach ?>
        <? endif ?>
    </ul><ul class="asso_mg tab-pane" id="atten">
    <? if($f_corporations): ?>
