...
<h4 class="title_01 title_02"><span>设置</span><a class="oprate_w" href="http://localhost:8088">回到首页</a></h4>
...
<div id="set_pass" class="tab-pane">
...
<div id="set_privacy" class="tab-pane">
...
<ul class="siderbar" id="myTab">
    <li class="active">
        <a href="#account" data-toggle="tab">资料设置</a>
    </li>
    <li>
        <a href="#set_head" data-toggle="tab">头像设置</a>
    </li>
    <li>
        <a href="#set_pass" data-toggle="tab">账户设置</a>
    </li>
    <li>
        <a href="#set_privacy" data-toggle="tab">隐私设置</a>
    </li>
</ul>
</div>
</div>
