...
<div id="write_letter_area" style="display:none">
	<div class="control-group">
			    ...
			    <div class="controls">
			      <div id="receiver"></div>
                    <a href="#popup4" class="btn" data-toggle="modal" id="check_linkman">选择收信人</a>
...
<div id="popup4" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="myModalLabel">选择收信人</h3>
    </div>
